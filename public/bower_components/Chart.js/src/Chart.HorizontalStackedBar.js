		...
		getBarsAtEvent : function(e){
			...
			for (var datasetIndex = 0; datasetIndex < this.datasets.length; datasetIndex++) {
				for (barIndex = 0; barIndex < this.datasets[datasetIndex].bars.length; barIndex++) {
					/*if (eventPosition.inRange(this.datasets[datasetIndex].bars[barIndex].x,this.datasets[datasetIndex].bars[barIndex].y)){
					...
					if(this.datasets[datasetIndex].bars[barIndex].x > eventPosition.x) {
						if((this.datasets[datasetIndex].bars[barIndex].y + this.datasets[datasetIndex].bars[barIndex].height) > eventPosition.y){
							//console.log(this.datasets[datasetIndex].bars[barIndex].y);
		...
		draw : function(ease){
			...
			helpers.each(this.datasets,function(dataset,datasetIndex){
				helpers.each(dataset.bars,function(bar,index){
					var x = this.scale.calculateBarY(this.datasets, datasetIndex, index, bar.value),
					...
					bar.transition({
						...
						//y : this.scale.calculateBarX(index),
						x : Math.abs(x),
