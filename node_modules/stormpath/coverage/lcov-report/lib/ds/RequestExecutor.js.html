...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/ds/RequestExecutor.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/ds/</a> &#187; RequestExecutor.js</div>
</div>
<div class="body">
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (_(uri).startsWith('/')) {
    return BASE_URL + uri;
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return BASE_URL + '/' + uri;</span>
}
&nbsp;
/**
 *
