...
<div class="header medium">
    ...
    <h2>
        ...
        Statements: <span class="metric">66.32% <small>(63 / 95)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">66.32% <small>(63 / 95)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
 ...
 * @version 0.1
 */
Client.prototype.createResource = <span class="fstat-no" title="function not covered" >function createResource(/* parentHref, [query,] data, [InstanceConstructor,] callback */) {</span>
<span class="cstat-no" title="statement not covered" >  this._dataStore.createResource.apply(this._dataStore, arguments);</span>
};
&nbsp;
//convenience methods:
&nbsp;
Client.prototype.getApplications = <span class="fstat-no" title="function not covered" >function getClientApplications(/* [options,] callback */) {</span>
...
<span class="cstat-no" title="statement not covered" >  return self.getCurrentTenant(<span class="fstat-no" title="function not covered" >function onGetCurrentTenantForApplications(err, tenant) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      return callback(err, null);</span>
    }
<span class="cstat-no" title="statement not covered" >    return tenant.getApplications(options, callback);</span>
  });
};
&nbsp;
...
&nbsp;
Client.prototype.getDirectories = <span class="fstat-no" title="function not covered" >function getClientDirectories(/* [options,] callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
<span class="cstat-no" title="statement not covered" >  var args = Array.prototype.slice.call(arguments);</span>
<span class="cstat-no" title="statement not covered" >  var callback = args.pop();</span>
<span class="cstat-no" title="statement not covered" >  var options = (args.length &gt; 0) ? args.shift() : null;</span>
<span class="cstat-no" title="statement not covered" >  return self.getCurrentTenant(<span class="fstat-no" title="function not covered" >function onGetCurrentTenantForDirectories(err, tenant) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      return callback(err, null);</span>
    }
...
Client.prototype.getApplication = <span class="fstat-no" title="function not covered" >function getClientApplication(/* href, [options,], callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
<span class="cstat-no" title="statement not covered" >  var args = Array.prototype.slice.call(arguments);</span>
...
<span class="cstat-no" title="statement not covered" >  var options = (args.length &gt; 0) ? args.shift() : null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return self.getResource(href, options, require('./resource/Application'), callback);</span>
};
...
Client.prototype.getGroupMembership = <span class="fstat-no" title="function not covered" >function getClientGroupMembership(/* href, [options,], callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
<span class="cstat-no" title="statement not covered" >  var args = Array.prototype.slice.call(arguments);</span>
<span class="cstat-no" title="statement not covered" >  var href = args.shift();</span>
<span class="cstat-no" title="statement not covered" >  var callback = args.pop();</span>
<span class="cstat-no" title="statement not covered" >  var options = (args.length &gt; 0) ? args.shift() : null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return self.getResource(href, options, require('./resource/GroupMembership'), callback);</span>
};
&nbsp;
module.exports = Client;</pre></td></tr>
</table></pre>
