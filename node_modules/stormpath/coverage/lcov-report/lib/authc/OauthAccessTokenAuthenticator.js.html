...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/authc/OauthAccessTokenAuthenticator.js</span></h1>
    <h2>
        
        Statements: <span class="metric">93.55% <small>(58 / 62)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/authc/</a> &#187; OauthAccessTokenAuthenticator.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span></td><td class="text"><pre class="prettyprint lang-js">var ApiAuthRequestError = require('../error/ApiAuthRequestError');
...
<span class="cstat-no" title="statement not covered" >      return new ApiAuthRequestError('Missing or invalid jwt parameter: ' + requiredFields[i][0]);</span>
    }
  }
...
<span class="cstat-no" title="statement not covered" >    return new ApiAuthRequestError('scope must be a string');</span>
  }
  return null;
}
&nbsp;
...
OauthAccessTokenAuthenticator.prototype.authenticate = function authenticate(callback) {
  ...
  if(subject.match(/accounts/)){
    self.application.dataStore.getResource(subject,null,require('../resource/Account'),function(err,account){
      if(err){
        callback(err.status===404 ? new ApiAuthRequestError('Invalid Client Credentials', 401) : <span class="branch-1 cbranch-no" title="branch not covered" >err)</span>;
...
<span class="cstat-no" title="statement not covered" >        callback(err.status===404 ? new ApiAuthRequestError('Invalid Client Credentials', 401) : err);</span>
...
<span class="cstat-no" title="statement not covered" >        callback(new ApiAuthRequestError('Invalid Client Credentials', 401));</span>
      }
    });
  }
};
&nbsp;
module.exports = OauthAccessTokenAuthenticator;</pre></td></tr>
</table></pre>
